...
(* OASIS_START *)
(* DO NOT EDIT (digest: e81b926e7a9e71622b19ec0ed68f5922) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Hao Wu"];
          homepage = None;
          synopsis = "A Ocaml library for word case conversions";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Eªø£w'\132µN2®ñ\001AWV";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
